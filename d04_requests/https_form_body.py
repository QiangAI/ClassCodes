...
ssl_sk.connect(('fanyi.baidu.com', 443))
...
str_request += 'Host: fanyi.baidu.com\r\n'
...
str_request += 'Referer: https://fanyi.baidu.com/\r\n'
...
if result:
    ...
    # 全部数据读取完毕
    print('--------------------')
    print(eval(content_buffer.decode('utf-8')))
    print(content_buffer.decode('unicode_escape'))
