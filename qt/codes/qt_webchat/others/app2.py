...
from PyQt5.QtWidgets import QApplication, QWidget, QTabWidget, QTextBrowser, QTextEdit, QListWidgetItem, QCheckBox, \
    QLabel, QPushButton, QVBoxLayout, QHBoxLayout, QGridLayout, QListWidget, QMenu, QSystemTrayIcon, QAction
...
class mainWindow(QTabWidget):
    ...
    def fillContact(self, _fullContact):
        ...
        for each in _fullContact:
            ...
            # | NickName, Sex, Province, City, signature, FromUserName |
            self.AllFriendsInfo[str] = [each['NickName'], each['Sex'], each['Province'], each['City'],
    ...
    def generateWordCloud(self):
        ...
        my_wordcloud = wordcloud.WordCloud(background_color="white", max_words=2000,
                                           ...
                                           font_path="qrc/FZSTK.ttf").generate(
            text)  # 生成词云。font_path="C:\Windows\Fonts\msyhl.ttc"指定字体，有些字不能解析中文，这种情况下会出现乱码。
